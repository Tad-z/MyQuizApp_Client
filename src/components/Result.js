...
import { attempts_Number, earnedPoints_Number, resultStatus } from "../helper/helper";
...
export default function Result() {
  ...
  /** store user data */
  usePostResult({ result, username: userId, attempts, points: earnedPoints, status: status ? "Passed" : "Failed" })
    ...
    <div className="container">
      ...
      <div className="result flex-center">
        ...
        <div className="flex">
          ...
          <span style={{ color : `${status ? "#2aff95" : "#ff2a66"}`}} className="bold">{status ? "Passed" : "Failed"}</span>
        </div>
      </div>
      <div className="start">
